...
const OnboardingInstructions: React.FC<OnboardingInstructionsProps> = ({
  ...
  const steps = [
    {
      ...
      description: "thadm runs quietly in the background, capturing your screen and audio activities without interruption.",
      color: "text-blue-500"
    },
    {
      icon: Clock,
  ...
  const shortcuts = [
    { key: "⌘ + ⌥ + S", description: "Show/Hide thadm" },
    ...
    <div className={`flex justify-center items-center flex-col space-y-6 p-8 ${className}`}>
      <div className="flex flex-col px-2 justify-center items-center mb-6">
        ...
        <p className="text-center text-text-secondary max-w-md">
          thadm is now configured and ready to help you remember everything. Here&apos;s how to get the most out of it.
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center space-y-6">
        ...
        >
          <p className="text-sm text-text-secondary mb-4">
            Start using your computer normally. thadm will build your timeline in the background.
          </p>
